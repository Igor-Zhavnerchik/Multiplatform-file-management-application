  ...
  import 'package:cross_platform_project/presentation/screens/splash_screen/flutter_splash_screen.dart';
  ...
  final routerProvider = Provider<GoRouter>((ref) {
    return GoRouter(
      routes: [
        GoRoute(path: '/', builder: (context, state) => FlutterSplashScreen()),
        GoRoute(
          path: '/home',
